...
contract sMushERC20Token is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked MushDAO", "sMUSH", 9) ERC20Permit() {
    ...
    /**
        @notice increases sMUSH supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sMUSH
